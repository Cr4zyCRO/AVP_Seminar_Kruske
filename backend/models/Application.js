  ...
  static get jsonSchema() {
    return {
      ...
      properties: {
        ...
        company_mentor_id: { type: ['string', 'null'], format: 'uuid' },
        faculty_mentor_id: { type: ['string', 'null'], format: 'uuid' },
        uputnica_file: { type: ['string', 'null'] },
        uptnica_status: { type: ['string', 'null'] },
        status: { type: 'string' },
      },
    };
  }
